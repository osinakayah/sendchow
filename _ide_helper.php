 ...
 * Generated for Laravel 5.5.13 on 2017-11-27.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class App {
        ...
        /**
         * RegisterContract a callback to run after loading the environment.
         *
        ...
        /**
         * RegisterContract a callback to run before a bootstrapper.
         *
        ...
        /**
         * RegisterContract a callback to run after a bootstrapper.
         *
         * @param string $bootstrapper
         * @param \Closure $callback
         * @return void 
        ...
        /**
         * RegisterContract all of the configured providers.
         *
         * @return void 
         * @static 
         */ 
        ...
        /**
         * RegisterContract a service provider with the application.
         *
        ...
        /**
         * RegisterContract a deferred provider and service.
         *
         * @param string $provider
        ...
        /**
         * RegisterContract a new boot listener.
         *
        ...
        /**
         * RegisterContract a new "booted" listener.
         *
         * @param mixed $callback
         * @return void 
         * @static 
        ...
        /**
         * RegisterContract a terminating callback with the application.
         *
         * @param \Closure $callback
         * @return $this 
         * @static 
        ...
        /**
         * RegisterContract the core class aliases in the container.
         *
         * @return void 
         * @static 
         */ 
        ...
        /**
         * RegisterContract a binding with the container.
         *
        ...
        /**
         * RegisterContract a binding if it hasn't already been registered.
         *
         * @param string $abstract
         * @param \Closure|string|null $concrete
         * @param bool $shared
        ...
        /**
         * RegisterContract a shared binding in the container.
         *
         * @param string|array $abstract
         * @param \Closure|string|null $concrete
         * @return void 
        ...
        /**
         * RegisterContract an existing instance as shared in the container.
         *
         * @param string $abstract
         * @param mixed $instance
         * @return mixed 
        ...
        /**
         * RegisterContract a new resolving callback.
         *
         * @param string $abstract
        ...
        /**
         * RegisterContract a new after resolving callback for all types.
         *
         * @param string $abstract
         * @param \Closure|null $callback
         * @return void 
    ...
    class Artisan {
        ...
        /**
         * RegisterContract a Closure based command with the application.
         *
        ...
        /**
         * RegisterContract the given command with the console application.
         *
    ...
    class Auth {
        ...
        /**
         * RegisterContract a new callback based request guard.
         *
         * @param string $driver
         * @param callable $callback
         * @return $this 
        ...
        /**
         * RegisterContract a custom driver creator Closure.
         *
         * @param string $driver
         * @param \Closure $callback
         * @return $this 
        ...
        /**
         * RegisterContract a custom provider creator Closure.
         *
         * @param string $name
         * @param \Closure $callback
         * @return $this 
         ...
         *
         * @return \SendChow\Modules\Authentication\Model\UserMock|null 
         * @static 
         */ 
         ...
         *
         * @param mixed $id
         * @return \SendChow\Modules\Authentication\Model\UserMock|false 
         * @static 
         */ 
        ...
        /**
         * RegisterContract an authentication attempt event listener.
         *
         * @param mixed $callback
         * @return void 
         * @static 
         ...
         *
         * @return \SendChow\Modules\Authentication\Model\UserMock 
         * @static 
         */ 
        ...
        /**
         * RegisterContract a custom macro.
         *
         * @param string $name
    ...
    class Blade {
        ...
        /**
         * RegisterContract a custom Blade compiler.
         *
        ...
        /**
         * RegisterContract an "if" statement directive.
         *
         * @param string $name
         * @param callable $callback
         * @return void 
        ...
        /**
         * RegisterContract a handler for custom directives.
         *
         * @param string $name
    ...
    class Broadcast {
        ...
        /**
         * RegisterContract the routes for handling broadcast authentication and sockets.
         *
    ...
    class DB {
        ...
        /**
         * RegisterContract an extension connection resolver.
         *
         * @param string $name
        ...
        /**
         * RegisterContract a database query listener with the connection.
         *
         * @param \Closure $callback
         * @return void 
         * @static 
        ...
        /**
         * RegisterContract a connection resolver.
         *
         * @param string $driver
         * @param \Closure $callback
         * @return void 
    ...
    class Event {
        ...
        /**
         * RegisterContract an event listener with the dispatcher.
         *
        ...
        /**
         * RegisterContract an event and payload to be fired later.
         *
         * @param string $event
         * @param array $payload
         * @return void 
        ...
        /**
         * RegisterContract an event subscriber with the dispatcher.
         *
    ...
    class Gate {
        ...
        /**
         * RegisterContract a callback to run before all Gate checks.
         *
         * @param callable $callback
         * @return $this 
         * @static 
        ...
        /**
         * RegisterContract a callback to run after all Gate checks.
         *
         * @param callable $callback
         * @return $this 
         * @static 
    ...
    class Log {
        ...
        /**
         * RegisterContract a file log handler.
         *
         * @param string $path
         * @param string $level
         * @return void 
        ...
        /**
         * RegisterContract a daily file log handler.
         *
         * @param string $path
         * @param int $days
         * @param string $level
        ...
        /**
         * RegisterContract a Syslog handler.
         *
         * @param string $name
         * @param string $level
        ...
        /**
         * RegisterContract an error_log handler.
         *
         * @param string $level
        ...
        /**
         * RegisterContract a new callback handler for when a log event is triggered.
         *
         * @param \Closure $callback
         * @return void 
         * @throws \RuntimeException
    ...
    class Queue {
        ...
        /**
         * RegisterContract an event listener for the before job event.
         *
         * @param mixed $callback
         * @return void 
         * @static 
        ...
        /**
         * RegisterContract an event listener for the after job event.
         *
         * @param mixed $callback
         * @return void 
         * @static 
        ...
        /**
         * RegisterContract an event listener for the exception occurred job event.
         *
         * @param mixed $callback
         * @return void 
         * @static 
        ...
        /**
         * RegisterContract an event listener for the daemon queue loop.
         *
         * @param mixed $callback
         * @return void 
         * @static 
        ...
        /**
         * RegisterContract an event listener for the failed job event.
         *
         * @param mixed $callback
         * @return void 
         * @static 
        ...
        /**
         * RegisterContract an event listener for the daemon queue stopping.
         *
         * @param mixed $callback
         * @return void 
         * @static 
    ...
    class Route {
        ...
        /**
         * RegisterContract a new GET route with the router.
         *
         * @param string $uri
        ...
        /**
         * RegisterContract a new POST route with the router.
         *
         * @param string $uri
         * @param \Closure|array|string|null $action
         * @return \Illuminate\Routing\Route 
        ...
        /**
         * RegisterContract a new PUT route with the router.
         *
         * @param string $uri
         * @param \Closure|array|string|null $action
         * @return \Illuminate\Routing\Route 
        ...
        /**
         * RegisterContract a new PATCH route with the router.
         *
         * @param string $uri
         * @param \Closure|array|string|null $action
         * @return \Illuminate\Routing\Route 
        ...
        /**
         * RegisterContract a new DELETE route with the router.
         *
         * @param string $uri
         * @param \Closure|array|string|null $action
         * @return \Illuminate\Routing\Route 
        ...
        /**
         * RegisterContract a new OPTIONS route with the router.
         *
         * @param string $uri
         * @param \Closure|array|string|null $action
         * @return \Illuminate\Routing\Route 
        ...
        /**
         * RegisterContract a new route responding to all verbs.
         *
         * @param string $uri
         * @param \Closure|array|string|null $action
         * @return \Illuminate\Routing\Route 
        ...
        /**
         * RegisterContract a new Fallback route with the router.
         *
         * @param \Closure|array|string|null $action
         * @return \Illuminate\Routing\Route 
         * @static 
        ...
        /**
         * RegisterContract a new route that returns a view.
         *
         * @param string $uri
         * @param string $view
         * @param array $data
        ...
        /**
         * RegisterContract a new route with the given verbs.
         *
        ...
        /**
         * RegisterContract an array of resource controllers.
         *
        ...
        /**
         * RegisterContract a route matched event listener.
         *
        ...
        /**
         * RegisterContract a short-hand name for a middleware.
         *
         * @param string $name
         * @param string $class
         * @return $this 
        ...
        /**
         * RegisterContract a group of middleware.
         *
         * @param string $name
        ...
        /**
         * RegisterContract a model binder for a wildcard.
         *
         * @param string $key
         * @param string $class
         * @param \Closure|null $callback
        ...
        /**
         * RegisterContract the typical authentication routes for an application.
         *
         * @return void 
         * @static 
         */ 
    ...
    class Validator {
        ...
        /**
         * RegisterContract a custom validator extension.
         *
         * @param string $rule
        ...
        /**
         * RegisterContract a custom implicit validator extension.
         *
         * @param string $rule
         * @param \Closure|string $extension
         * @param string $message
        ...
        /**
         * RegisterContract a custom dependent validator extension.
         *
         * @param string $rule
         * @param \Closure|string $extension
         * @param string $message
        ...
        /**
         * RegisterContract a custom validator message replacer.
         *
         * @param string $rule
    ...
    class View {
        ...
        /**
         * RegisterContract a valid view extension and its engine.
         *
        ...
        /**
         * RegisterContract a view creator event.
         *
        ...
        /**
         * RegisterContract multiple view composers via an array.
         *
        ...
        /**
         * RegisterContract a view composer event.
         *
         * @param array|string $views
         * @param \Closure|string $callback
         * @return array 
...
namespace  { 
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {         
            ...
            /**
             * RegisterContract a new global scope.
             *
            ...
            /**
             * RegisterContract a replacement for the default delete function.
             *
             * @param \Closure $callback
             * @return void 
             * @static 
