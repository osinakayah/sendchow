        ...
        <div class="page-header page-header-small" filter-color="green">
            ...
            <div class="content-center">
                <div class="photo-container">
                    <img src="{{URL::asset("assets/img/restaurant-list.jpg")}}" style="width:100px;" alt="logo">
                </div>
                <h3 class="title">{{$restaurant->title}}</h3>
                <p class="category">@foreach($restaurant->categories as $category) {{$category->category}},@endforeach</p>
                <div class="content">
                    <div class="text-wrap">
                        @for($i = 0; $i <= 5; $i++)
